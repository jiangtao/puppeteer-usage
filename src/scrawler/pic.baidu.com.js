...
const logger = require("../utils/Logger").getLogger("pic.baidu.com");
const { time } = require("../utils/index");

const register = async function(word) {
  let count = 0;
  ...
  await page.goto(
    `https://pic.baidu.com/search/index?tn=baiduimage&ipn=r&ct=201326592&cl=2&lm=-1&st=-1&fm=index&fr=&hs=0&xthttps=111111&sf=1&fmq=&pv=&ic=0&nc=1&z=&se=1&showtab=0&fb=0&width=&height=&face=0&istype=2&ie=utf-8&word=${word}&oq=javascript&rsp=-1`
  );
